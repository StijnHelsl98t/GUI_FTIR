...
class create_tab_ftir_simulator(QWidget):
    ...
    def create_tab(self, parent):
        ...
        self.layout.line_edit_pathlength = QLineEdit("20.5")
        ...
        self.layout.addWidget(self.layout.label_molecule, 5,0,1,8)
        ...
        self.layout.addLayout(self.layout.grid_molecule,6,0,2,8)
        ...
        self.layout.addWidget(self.layout.button_save_molecules,8,0,1,1)
        self.layout.addWidget(self.layout.label_molecules, 8,1,1,7)
        ...
        self.layout.addWidget(self.layout.button_start_simulation, 9,0,1,4)

        self.layout.label_simulation = QLabel("No simulation done yet")
        self.layout.addWidget(self.layout.label_simulation,9,4,1,2)
        ...
        self.layout.addWidget(self.layout.label_name, 22, 0, 1, 2)
        self.layout.addWidget(self.layout.line_edit_name, 22, 2, 1, 2)
        self.layout.addWidget(self.layout.button_save_simulated_data_in_txt, 22, 4, 1, 1)
        self.layout.addWidget(self.layout.button_save_simulated_data_as_png, 22, 5, 1, 1)
        self.layout.addWidget(self.layout.label_save, 22, 6, 1, 2)
...
class create_tab_ftir_fitting(QWidget):
    ...
    def create_tab(self, parent):
        ...
        self.layout.addWidget(self.layout.label_temperature, 1, 0, 1, 2)
        self.layout.addWidget(self.layout.line_edit_temperature, 1, 2, 1, 3)
        self.layout.addWidget(self.layout.button_temperature, 1, 5, 1, 1)
        self.layout.addWidget(self.layout.label_temperature2,1, 6, 1, 2)
        ...
        self.layout.addWidget(self.layout.label_pressure, 2, 0, 1, 2)
        self.layout.addWidget(self.layout.line_edit_pressure, 2, 2, 1, 3)
        self.layout.addWidget(self.layout.button_pressure, 2, 5, 1, 1)
        self.layout.addWidget(self.layout.label_pressure2, 2, 6, 1, 2)

        # Create Row for path length
        ...
        self.layout.line_edit_pathlength = QLineEdit()
        self.layout.line_edit_pathlength.textChanged.connect(lambda:self.text_changed("Pathlength"))
        self.layout.line_edit_pathlength.setSizePolicy(QSizePolicy.Minimum, QSizePolicy.Minimum)
        ...
        self.layout.addWidget(self.layout.label_pathlength, 3, 0, 1, 2)
        self.layout.addWidget(self.layout.line_edit_pathlength, 3, 2, 1, 3)
        self.layout.addWidget(self.layout.button_pathlength, 3, 5, 1, 1)
        self.layout.addWidget(self.layout.label_pathlength2, 3, 6, 1, 2)
        ...
        self.layout.addLayout(self.layout.layout_grid_title,4,0,1,8)
        ...
        self.layout.addLayout(self.layout.grid_molecules,5,0,2,8)
        ...
        self.layout.addWidget(self.layout.button_ftir, 8, 0, 1, 2)

        self.layout.empty_space = QLabel("")
        self.layout.addWidget(self.layout.empty_space, 9, 0, 2, 8)

        self.layout.addWidget(self.parent.tab_ftir_fitting.inner_tab, 11, 0, 11, 8)

        self.layout.empty_space2 = QLabel("")
        self.layout.addWidget(self.layout.empty_space2, 22, 0, 1, 8)
...
class create_inner_tab_ftir_fitting(QTabWidget):
    ...
    def create_inner_tabs(self, parent):
        ...
        try:
            self.parent.tab_ftir_fitting.layout.removeWidget(self.parent.tab_ftir_fitting.layout.button_fit_single)
            self.parent.tab_ftir_fitting.layout.button_fit_single.deleteLater()
            self.parent.tab_ftir_fitting.layout.button_fit_single = None
            self.parent.tab_ftir_fitting.layout.removeWidget(self.parent.tab_ftir_fitting.layout.button_fit_single_redo)
            self.parent.tab_ftir_fitting.layout.button_fit_single_redo.deleteLater()
            self.parent.tab_ftir_fitting.layout.button_fit_single_redo = None
            self.parent.tab_ftir_fitting.layout.removeWidget(self.parent.tab_ftir_fitting.layout.label_info_fit)
            self.parent.tab_ftir_fitting.layout.label_info_fit.deleteLater()
            self.parent.tab_ftir_fitting.layout.label_info_fit = None
            self.parent.tab_ftir_fitting.layout.removeWidget(self.parent.tab_ftir_fitting.layout.button_fit_all)
            self.parent.tab_ftir_fitting.layout.button_fit_all.deleteLater()
            self.parent.tab_ftir_fitting.layout.button_fit_all = None
            self.parent.tab_ftir_fitting.layout.removeWidget(self.parent.tab_ftir_fitting.layout.button_fit_all_redo)
            self.parent.tab_ftir_fitting.layout.button_fit_all_redo.deleteLater()
            self.parent.tab_ftir_fitting.layout.button_fit_all_redo = None

            for f in range(len(self.files_in_directory_previous)):
                self.removeTab(0)

            self.parent.tab_ftir_fitting.layout.removeWidget(
                self.parent.tab_ftir_fitting.layout.button_transmission_vs_absorbance)
            self.parent.tab_ftir_fitting.layout.button_transmission_vs_absorbance.deleteLater()
            self.parent.tab_ftir_fitting.layout.button_transmission_vs_absorbance = None
            self.parent.tab_ftir_fitting.layout.removeWidget(
                self.parent.tab_ftir_fitting.layout.button_save_simulated_data_in_txt)
            self.parent.tab_ftir_fitting.layout.button_save_simulated_data_in_txt.deleteLater()
            self.parent.tab_ftir_fitting.layout.button_save_simulated_data_in_txt = None
            self.parent.tab_ftir_fitting.layout.removeWidget(
                self.parent.tab_ftir_fitting.layout.button_save_simulated_data_as_png)
            self.parent.tab_ftir_fitting.layout.button_save_simulated_data_as_png.deleteLater()
            self.parent.tab_ftir_fitting.layout.button_save_simulated_data_as_png = None
            self.parent.tab_ftir_fitting.layout.removeWidget(
                self.parent.tab_ftir_fitting.layout.button_save_simulated_data_in_txt_all)
            self.parent.tab_ftir_fitting.layout.button_save_simulated_data_in_txt_all.deleteLater()
            self.parent.tab_ftir_fitting.layout.button_save_simulated_data_in_txt_all = None
            self.parent.tab_ftir_fitting.layout.removeWidget(
                self.parent.tab_ftir_fitting.layout.button_save_simulated_data_as_png_all)
            self.parent.tab_ftir_fitting.layout.button_save_simulated_data_as_png_all.deleteLater()
            self.parent.tab_ftir_fitting.layout.button_save_simulated_data_as_png_all = None
            self.parent.tab_ftir_fitting.layout.removeWidget(self.parent.tab_ftir_fitting.layout.label_save)
            self.parent.tab_ftir_fitting.layout.label_save.deleteLater()
            self.parent.tab_ftir_fitting.layout.label_save = None
            ...
            for i in range(len(self.array_data)):
                ...
                self.parent.worker_plotting.fitting_and_residual_plot(
                    ["ftir_fitting_" + str(self.files_in_directory[i]), w_exp, t_exp])
            ...
            self.parent.tab_ftir_fitting.layout.button_fit_all_redo.clicked.connect(
                lambda: self.button_pressed("Redo fitting all"))
            ...
            self.parent.tab_ftir_fitting.layout.addWidget(
                self.parent.tab_ftir_fitting.layout.button_transmission_vs_absorbance, 10,5,1,3)

            if np.round(np.mean(data_transmission)) == 0:
            ...
            self.parent.tab_ftir_fitting.layout.button_save_simulated_data_as_png = QPushButton(
                "Save fitted data as png")
            ...
            self.parent.tab_ftir_fitting.layout.addWidget(
                self.parent.tab_ftir_fitting.layout.button_save_simulated_data_in_txt, 22, 0, 1, 1)
            self.parent.tab_ftir_fitting.layout.addWidget(
                self.parent.tab_ftir_fitting.layout.button_save_simulated_data_as_png, 22, 1, 1, 2)
            self.parent.tab_ftir_fitting.layout.addWidget(
                self.parent.tab_ftir_fitting.layout.button_save_simulated_data_in_txt_all, 22, 3, 1, 1)
            self.parent.tab_ftir_fitting.layout.addWidget(
                self.parent.tab_ftir_fitting.layout.button_save_simulated_data_as_png_all, 22, 4, 1, 2)
            self.parent.tab_ftir_fitting.layout.addWidget(
                self.parent.tab_ftir_fitting.layout.label_save, 22, 6, 1, 2)
        except:
            for i in range(len(self.array_data)):
                try:
                    data_wavelength = np.array(self.array_data[i].get_range("AB")[0:-1])
            ...
            self.parent.tab_ftir_fitting.layout.addWidget(
                self.parent.tab_ftir_fitting.layout.button_save_simulated_data_as_png_all, 22, 4, 1, 2)
            self.parent.tab_ftir_fitting.layout.addWidget(self.parent.tab_ftir_fitting.layout.label_save, 22, 6, 1, 2)
            self.files_in_directory_previous = self.files_in_directory
